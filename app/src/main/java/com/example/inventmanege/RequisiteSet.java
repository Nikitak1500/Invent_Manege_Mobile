...
public class RequisiteSet extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_requisite_set);
        ...
        Call<List<Inventory>> call = inventServerAPI.getRequisites(map);
    ...
    public void drawInv(List<Inventory> inventories) {
        ...
        LinearLayout container = findViewById(R.id.RequisiteScroll);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(RequisiteSet.this, OptionsMain.class);
