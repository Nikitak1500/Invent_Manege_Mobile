...
public class RespInv extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_resp_inv);
        ...
        map.put("resp", worker.getIdworker() + "");

        Call<List<Inventory>> call = inventServerAPI.getByResp(map);
    ...
    public void drawInv(List<Inventory> inventories) {
        ...
        LinearLayout container = findViewById(R.id.scrollConteiner);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(RespInv.this, OptionsMain.class);
