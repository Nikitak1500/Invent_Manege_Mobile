...
public class CostumeSet extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_costume_set);
        ...
        Call<List<Inventory>> call = inventServerAPI.getCostumes(map);
    ...
    public void drawInv(List<Inventory> inventories) {
        ...
        LinearLayout container = findViewById(R.id.CostumesScroll);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(CostumeSet.this, OptionsMain.class);
